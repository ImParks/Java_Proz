...
SELECT * FROM NPC WHERE N_name = 
update board set b_title = 1 ,B_hit = b_hit + 1 ,b_text = 3;
update Npc set N_hp = N_MaxHp , N_gold = 300 where N_no = 1;
...
select * FROM MONSTER;
INSERT INTO Monster(M_name,M_hp,M_maxHp,M_atk,M_gold,M_exp) VALUE ('허수아비',100,100,10,100,20);
